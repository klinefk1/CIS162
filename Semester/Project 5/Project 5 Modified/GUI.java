...
/*************************************************************
 * GUI for my adventure game
 * 
 * @author Katherine Klinefelter
 * @version 2014
 ************************************************************/
public class GUI extends JPanel{
    ...
    private class ButtonListener implements ActionListener{
        ...
        //removes the Tardis from the room you are leaving
        public void emptyMapRoom()
        {
            frame.map.emptySpace(myGame.getCurrentRoom().getDescription());
        }

        //adds the Tardis to the room in which you arrive
        public void moveTardis()
        {
            frame.map.moveTardis(myGame.getCurrentRoom().getDescription());
